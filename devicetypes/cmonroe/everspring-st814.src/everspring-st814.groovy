...
def configure() 
{
	log.debug "sending config values..."
	...
	delayBetween([
        ...
        /* report a humidity change of 1 percent */
        zwave.configurationV1.configurationSet(parameterNumber: 8, size: 1, scaledConfigurationValue: 1).format()
